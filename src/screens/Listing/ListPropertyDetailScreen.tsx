...
async function onSaveImage(image: Image[] | null) {
  ...
  const validateForm = () => {
   ...
   const newErrors = {
     ...
     furnishingType: normalizedPropertyType !== 'commercial' && !furnishingType,
...
const checkfacility =
  ...
  const [postsucessshowModal, setpostsucessShowModal] = useState<boolean>(false);
  ...
  const contectdetailsmodal = () => {
    ...
    const [postfailedModal, setpostfailedShowModal] =
            ...
            <View
              ...
              <TouchableWithoutFeedback>
                <View className="rounded-lg p-4 bg-white w-[90%]">
                  ...
                  <TouchableOpacity
                    onPress={() => setpostfailedShowModal(false)}
                    className="w-full p-3 rounded-full mt-2"
          ...
          /> */}
            ...
            <View style={{marginHorizontal: 24, marginTop: 16, height: 120}}>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{color: '#181A53', fontSize: 16, fontWeight: '500'}}>
            ...
            <View
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                />
                <Text
                  style={{fontSize: 14, color: '#181A53', fontWeight: '500'}}>
                  Charges
                </Text>
              </View>

              <Text
                style={{color: '#181A53', fontSize: 16, fontWeight: 'bold'}}>
                50 Coins
              </Text>
            </View>
            <View
